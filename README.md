...
- On a phone the Home team strip is one scrolling line of small faces instead of a wall of large ones, and the projects table keeps the project, its next shoot day and its open tasks, dropping status, progress and budget. Desktop is unchanged.
