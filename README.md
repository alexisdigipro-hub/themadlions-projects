...
- Home opens with **the team**: everyone left to right as small photos (initials until they upload one). Anyone who marked themselves Not available in the calendar is greyed out and crossed through for the day you are looking at, and the strip follows whichever day you pick in the mini calendar below it. Click a face to open that person's profile. Everyone sees it.
